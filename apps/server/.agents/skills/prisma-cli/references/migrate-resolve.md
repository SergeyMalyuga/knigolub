...
```bash
server migrate resolve [options]
```
...
```bash
server migrate resolve --applied 20240101000000_initial_migration
```
...
```bash
server migrate resolve --rolled-back 20240115120000_failed_migration
```
