...
```bash
npm install @server/adapter-better-sqlite3
```
...
```bash
npm install @server/adapter-mssql mssql
```
...
```typescript
import { PrismaClient } from '../generated/client'
import { PrismaMariaDb } from '@server/adapter-mariadb'
...
```typescript
import { PrismaClient } from '../generated/client'
import { PrismaBetterSqlite3 } from '@server/adapter-better-sqlite3'
...
```typescript
import { PrismaClient } from '../generated/client'
import { PrismaNeon } from '@server/adapter-neon'
...
```typescript
import { PrismaClient } from '../generated/client'
import { PrismaMssql } from '@server/adapter-mssql'
