...
```bash
bunx @server/cli@latest app deploy --framework nextjs --env .env
```
...
```bash
bunx @server/cli@latest app deploy --framework nestjs --env .env
```
...
```bash
bunx @server/cli@latest app deploy --framework tanstack-start --env .env
```
...
```bash
bunx @server/cli@latest app deploy --framework nuxt --env .env
```
...
```bash
bunx @server/cli@latest app deploy --framework astro --env .env
```
...
```bash
bunx @server/cli@latest app deploy api --branch feature/foo --json
```
