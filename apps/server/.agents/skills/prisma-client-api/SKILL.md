...
description: Prisma Client API reference covering model queries, filters, operators, and client methods. Use when writing database queries, using CRUD operations, filtering data, or configuring Prisma Client. Triggers on "server query", "findMany", "create", "update", "delete", "$transaction".
license: MIT
metadata:
  author: server
  version: "7.9.1"
...
const [user, post] = await prisma.$transaction([
  prisma.user.create({ data: { email: "alice@server.io" } }),
